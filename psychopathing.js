...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    function setUp(canvas_pass, style = "#000000") {
        ...
        window.addEventListener('pointerdown', e => {
            ...
            psyk.target.x = TIP_engine.x
            psyk.target.y = TIP_engine.y
...
//         console.log(gamepadAPI.axesStatus[1]*gamepadAPI.axesStatus[0]) //debugging
    ...
    class Psychopather{
        constructor(){
            this.body = new Circle(350,350, 3, "#00FFFF")
            this.obstacles = []
            this.target = new Circle(350,350, 3, "#00FFFF")

            for(let t = 0;t<0;t++){
                let ob = new Circle(Math.random()*canvas.width, Math.random()*canvas.height, 60, "#FFFF00")
                // if(Math.random()<.5){
                //     ob.width = 100
                // }else{
                //     ob.height = 100
            ...
            for(let t = 0;t<16;t++){
                let ob = new Circle((t%4)*(1280*.25) + 100, Math.floor(t/4)*(720*.25)+150, 40+(Math.random()*20), "#FFFF00")
                // if(Math.random()<.5){
                //     ob.width = 100
                // }else{
                //     ob.height = 100
            ...
            for(let t = 0;t<16;t++){
                let ob = new Circle((t%4)*(1280*.25) + 250, Math.floor(t/4)*(720*.25)+50, 60, "#FFFF00")
                // if(Math.random()<.5){
                //     ob.width = 100
                // }else{
                //     ob.height = 100
            ...
            for(let t = 0;t<106;t++){
                let ob = new Circle((t*1)+ 700, (t*2)+ 200, 60, "#FFFF00")
                // if(Math.random()<.5){
                //     ob.width = 100
                // }else{
                //     ob.height = 100
